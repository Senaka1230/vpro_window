...
export const handleHorizontalSplitWindows = (canvas, rightMenuIndex, scale, createria, setCreateria, newCreateria, setCanvasState, setRestoreNum, setDeleteFlag) => {
      ...
      if (isCursorOverImage && barHeight > (2 * borderthickness + 4)) {
        ...
        if (!sortedVerticalOrderBars && !sortedHorizontalOrderBars) {
          ...
          if (createria === "D") {
            ...
            canvas.off();
            await mouseMoving(canvas, scale, newCreateria, setRestoreNum, setCanvasState, setDeleteFlag);
          }
...
export const handleVerticalSplitWindows = (canvas, rightMenuIndex, scale, createria, setCreateria, newCreateria, setCanvasState, setRestoreNum, setDeleteFlag) => {
