...
export const handleCreate = async (canvas, setScale, setCreateria, setCanvasState, setRestoreNum, setDeleteFlag, width, height, order) => {
  ...
  await mouseMoving(canvas, scaleAlt, "D", setRestoreNum, setCanvasState, setDeleteFlag);
